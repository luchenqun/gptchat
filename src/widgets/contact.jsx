  ...
  render() {
    ...
    if (typeof this.props.preview == "string") {
      ...
      preview = React.createElement(
        React.Fragment,
        null,
        Drafty.format(this.props.preview, previewFormatter, {
      ...
      preview = (
        <>
          <i className="material-icons gray">warning_amber</i>{" "}
          <i className="gray">
            <FormattedMessage
              id="invalid_content"
    ...
    return (
      <li
        className={
          !this.props.showCheckmark && this.props.selected ? "selected" : null
        }
      ...
      >
        <div className="avatar-box">
          ...
          />
          {this.props.deleted ? (
            <i className="deleted material-icons">cancel</i>
        ...
        <div className="text-box">
          <div>
            ...
            {this.props.isGroup ? (
              <i className="material-icons as-badge">group</i>
            ) : null}
            {this.props.isChannel ? (
              <img src="/img/channel.png" className="channel" alt="channel" />
            ) : null}
          ...
          {this.props.showMode ? (
            ...
            <div className="contact-comment">
              {marker}
              <span>{preview || this.props.comment || "\u00A0"}</span>
            </div>
          )}
        </div>
        {this.props.showContextMenu ? (
