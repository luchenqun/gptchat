...
export default class CallMessage extends React.PureComponent {
  render() {
    const isCallDropped = [
      ...
      "disconnected",
      "missed",
    ].includes(this.props.callState);
    const successClass =
      "material-icons medium " + (isCallDropped ? "red" : "green");
    ...
    return (
      <div className="call-message">
        <div>
          <i className="material-icons big gray">call</i>
        </div>
        <div className="flex-column narrow">
          ...
          <div className="duration">
            <i className={successClass}>{callIcon}</i> {duration}
          </div>
        </div>
      </div>
    );
