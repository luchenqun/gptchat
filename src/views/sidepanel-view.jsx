...
const AccountSettingsView = React.lazy((_) =>
  import("./account-settings-view.jsx")
);
import ContactsView from "./contacts-view.jsx";
const CreateAccountView = React.lazy((_) =>
  import("./create-account-view.jsx")
);
...
const PasswordResetView = React.lazy((_) =>
  import("./password-reset-view.jsx")
);
